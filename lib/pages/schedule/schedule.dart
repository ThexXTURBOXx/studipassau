...
class _SchedulePagePageState extends State<SchedulePage>
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: BlocBuilder<LoginCubit, LoginState>(
      builder:
          (context, stateL) => BlocConsumer<ScheduleCubit, ScheduleState>(
            listener: showErrorMessage,
            builder:
                (context, stateS) => RefreshIndicator(
                    ...
                    child: Column(
                      children: [
                        DatePageView(
                          ...
                          builder:
                              (context, date) => DateHeader(
                                date,
                                onTap:
                                    () async => dateControllerContent.animateTo(
                                      date,
                                      vsync: this,
                                    ),
                        ...
                        Expanded(
                          child: TimetableConfig<StudiPassauEvent>(
                            ...
                            eventProvider:
                                (visible) => getEvents(stateS.events, visible),
                            eventBuilder:
                                (context, event) => StudiPassauEventWidget(
                                  event,
